...
class SynteticWorld:
    def __init__(
        ...
        self.wall_polygon = self.create_polygon(external_polygon)
    ...
    def create_polygon(self, external_polygon: Polygon =None):
    ...
    def create_world(
        ...
        walls_model = extrude(
            ...
            color='xkcd')
        walls_model.name = self.world_name + '_wall'

        print(f"Extruded walls")
        print(f"{walls_model.name}")
        ...
        # print("Started free space method")
        ...
        # print(f"Got free space polygon")
